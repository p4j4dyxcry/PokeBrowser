    ...
    public static class DataLoader
    {
        ...
        public static void SavePersonalityToJson()
        {
            PersonalityData[] data = new[]
            {
                ...
                new PersonalityData("いじっぱり",PersonalityParameter.Attack,PersonalityParameter.SpAttack),
                new PersonalityData("ひかえめ",  PersonalityParameter.SpAttack,PersonalityParameter.Attack),
                new PersonalityData("ようき",    PersonalityParameter.Speed,PersonalityParameter.SpAttack),
                new PersonalityData("おくびょう",PersonalityParameter.Speed,PersonalityParameter.Attack),
                new PersonalityData("ずぶとい",  PersonalityParameter.Defence,PersonalityParameter.Attack),
                new PersonalityData("わんぱく",  PersonalityParameter.Defence,PersonalityParameter.SpAttack),
                new PersonalityData("おだやか",  PersonalityParameter.SpDefence,PersonalityParameter.Attack),
                new PersonalityData("しんちょう",PersonalityParameter.SpDefence,PersonalityParameter.SpAttack),
                ...
                new PersonalityData("ゆうかん",  PersonalityParameter.Attack,PersonalityParameter.Speed),
                new PersonalityData("れいせい",  PersonalityParameter.SpAttack,PersonalityParameter.Speed),
                ...
                new PersonalityData("さみしがり",PersonalityParameter.Attack,PersonalityParameter.Defence),
                new PersonalityData("やんちゃ",  PersonalityParameter.Attack,PersonalityParameter.SpDefence),
                new PersonalityData("おっとり",  PersonalityParameter.SpAttack,PersonalityParameter.Defence),
                new PersonalityData("うっかりや",PersonalityParameter.SpAttack,PersonalityParameter.SpDefence),
